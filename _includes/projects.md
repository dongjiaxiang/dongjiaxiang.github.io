...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="periodical"><a href="https://nips.cc/Conferences/2023">NeurIPS 2023</a> | Neural Information Processing Systems | <strong style="color: darkred;">Spotlight Paper</strong></div>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="periodical"><a href="https://www.2023.ieeeicme.org/">ICME 2023</a> | International Conference on Multimedia and Expo | <strong style="color: darkred;">Oral Paper</strong></div>
...
<div class="pub-row" style="max-width: 1000px;">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    ...
    <abbr class="badge">Science China</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><strong>Metadata-Informed Transformers for Informative Time Series Forecasting</strong></div>
